...
var findActorInfo = co.wrap(function*(actorModel) {
    ...
    if (queryRes.biography != undefined) {
        if (actorModel.description == undefined) {
    ...
    if (queryRes.birthday != undefined) {
        if (actorModel.date_of_birth == undefined) {
    ...
    if (queryRes.homepage != undefined) {
        if (actorModel.official_pages == undefined) {
            actorModel.official_pages = [];
        }
        

        if (!(_.includes(actorModel.official_pages, queryRes.homepage))) {
            if (queryRes.homepage != ""){
                actorModel.official_pages.push(queryRes.homepage);
                log.log(4, util.format("Added Official pages '%s' to actor '%s'", actorModel.official_pages, actorModel.name), 'colorWarn')
            }

            
        }
        // if (actorModel.official_pages.indexOf(queryRes.homepage) == -1) {
